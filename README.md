...
└── outputs/               # not in git; one folder per trained model (see below)
```
...
To be filled after training; `python3 compare.py` generates this table:

| Model | Params (M) | Val Dice | Patient Dice (mean±std) | Dice NCR/NET | Dice ED | Dice ET | IoU | ms/slice |
|---|---|---|---|---|---|---|---|---|
| unet | 31.0 | - | - | - | - | - | - | - |
| attention_unet | 31.4 | - | - | - | - | - | - | - |
| unetpp | 9.2 | - | - | - | - | - | - | - |
